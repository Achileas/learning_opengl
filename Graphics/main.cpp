...
int main()
{
	...
	float vertices1[] = {
		-0.6f, 0.7f, 0.0f,  // left triangle top
		-0.9f, 0.0f, 0.0f,  // left triangle left bottom
		-0.3f, 0.0f, 0.0f,   // left triangle right bottom
	};
	float vertices2[] = {
		0.6f, 0.7f, 0.0f,   // right triangle top bottom
		0.9f, 0.0f, 0.0f,   // right triangle left bottom
		0.3f, 0.0f, 0.0f,  // right triangle right bottom
	};
